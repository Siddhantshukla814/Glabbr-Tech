...
export const CONTACT_FAVOURITELIST_REQUEST = "CONTACT_FAVOURITELIST_REQUEST";
export const CONTACT_FAVOURITELIST_SUCCESS = "CONTACT_FAVOURITELIST_SUCCESS";
export const CONTACT_FAVOURITELIST_FAIL = "CONTACT_FAVOURITELIST_FAIL";
